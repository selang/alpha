...
if (window.top === window.self) {
    ...
    (function () {
        ...
        aggregationLogics.push(injectAggregationLogic().domain(['www.lsmpx.com', 'www.lsm.me']).switchAggregationBtn(function () {
            $('#thread-pic').hide();
            $('#thread-page').hide();
        }, function () {
            $('#thread-pic').show();
        ...
        aggregationLogics.push(injectAggregationLogic().domain('www.nvshens.com').removeAD(function () {
        ...
        aggregationLogics.push(injectAggregationLogic().domain(['www.xgtaotu.com', 'www.xgtutu.com']).removeAD(function () {
